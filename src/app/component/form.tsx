    ...
    return(
        ...
        <div className="w-full max-w-xs">
            ...
            <form
                ...
                <br />
                <button
                    className="bg-blue-400 p-2 m-2 rounded text-5m text white"
...
function submitForm(jawaban:any){
    return new Promise<void>((resolve, reject) => {
        setTimeout(() =>{
            ...
            if (shouldError){
                reject (new Error('Tebakan yang bagus tetapi jban salah. Silahkan coba lagi!'));
            } else{
                resolve();    
            }
        }, 500)
...
export function Form_2(){
    ...
    function handleLastNameChange (e:any) {
        ...
        setLastName(firstName + ' ' + e.target.value);
    }
